...
@InputType()
class RequestUpdateManyWithoutCreditCardHoldersInput {
...
export { RequestUpdateManyWithoutCreditCardHoldersInput as RequestUpdateManyWithoutCreditCardHoldersInput };
